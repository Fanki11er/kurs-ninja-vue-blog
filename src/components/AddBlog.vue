...
export default {
    data(){
        return{
           ...
           authors: ["The Net Ninja", "The Angular Avanger", "The Vue Vindyvcator"],
           submited: false,
        }
    },
    methods:{
        ...
        post: function(){
             this.$http.post('https://kurs-vuejs-blog.firebaseio.com/posts.json', this.blog)
             .then(function(data){
                 this.submited = true;
             })
        },
